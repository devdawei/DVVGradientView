//
//  LeftBottomToRightTopViewController.m
//  DVVGradientView
//
...
@interface LeftBottomToRightTopViewController ()

@property (nonatomic, strong) DVVGradientView *gradientView;

@end

@implementation LeftBottomToRightTopViewController
...
- (DVVGradientView *)gradientView {
    if (!_gradientView) {
        ...
        _gradientView.type = DVVGradientViewTypeLeftBottomToRightTop;
    }
