//
//  LeftTopToRightBottomViewController.m
//  DVVGradientView
//
...
@interface LeftTopToRightBottomViewController ()

@property (nonatomic, strong) DVVGradientView *gradientView;

@end

@implementation LeftTopToRightBottomViewController
...
- (DVVGradientView *)gradientView {
    if (!_gradientView) {
        ...
        _gradientView.type = DVVGradientViewTypeLeftTopToRightBottom;
    }
