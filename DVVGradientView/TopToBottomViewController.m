...
@interface TopToBottomViewController ()

@property (nonatomic, strong) DVVGradientView *gradientView;

@end

@implementation TopToBottomViewController
...
- (DVVGradientView *)gradientView {
    if (!_gradientView) {
        ...
        _gradientView.type = DVVGradientViewTypeTopToBottom;
    }
